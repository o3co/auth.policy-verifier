...
interface DeterminingPolicies {                                      // #199 — build with boundDeterminingPolicies
...
const rule: Rule = {
  ...
  verify(attrs, report) {
    ...
    report?.({
      ...
      ...boundDeterminingPolicies([...answer.determiningPolicies].sort()),
    });
